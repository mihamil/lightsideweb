...
function jupiterx_register_tgmpa_plugins() {
	if ( ! jupiterx_is_premium() ) :
		$free_plugins = [
			...
			[
				'name' => __( 'LayerSlider WP', 'jupiterx' ),
				'slug' => 'LayerSlider',
				'required' => false,
				'force_activation' => false,
				'force_deactivation' => false,
			...
			[
				'name' => __( 'WPBakery Page Builder (Modified Version)', 'jupiterx' ),
			...
			[
				'name' => esc_html__( 'Qi Addons For Elementor', 'jupiterx' ),
			...
			[
				'name' => esc_html__( 'leadin', 'jupiterx' ),
				'slug' => 'leadin',
				'required' => false,
				'force_activation' => false,
				'force_deactivation' => false,
		...
		$qi_plugin = [
			...
			'slug' => 'qi-addons-for-elementor',
			'basename' => 'qi-addons-for-elementor/class-qiaddonsforelementor.php',
		];
		...
		array_push( $plugins, $qi_plugin );
		array_push( $plugins, $leadin );

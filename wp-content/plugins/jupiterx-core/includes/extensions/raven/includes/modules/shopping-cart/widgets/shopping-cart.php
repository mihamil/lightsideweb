...
class Shopping_Cart extends Base_Widget {
	...
	protected function render() {
		...
		?>
		<div class="raven-shopping-cart-wrap" data-is-product="<?php echo esc_attr( $is_product_page ); ?>">
	...
	protected function render_quick_cart_view() {
		...
		if ( ( $cart_qucik_view || is_cart() || is_checkout() ) && $enable_quick_view ) {
			return;
		}
		...
		jupiterx_open_markup_e(
			...
			if ( ! empty( WC()->cart ) ) {
				echo '<div class="widget woocommerce widget_shopping_cart"><div class="widget_shopping_cart_content">' . Module::render_mini_cart() . '</div></div>';
			}
